...
public class Layer3Test {
    ...
    @Before
    public void setUp() {
        this.layer = new Layer3(2, "1");
		this.layer2 = new Layer3(4, "2");
    }
	...
	public void testSetNextLayer() {
		...
		//Layer3 actualValue = layer.getPrevLayer();
	...
	public void testSendOutput() {
		Layer3 l = new Layer3(3, "1", new Identity());
        Layer3 l2 = new Layer3(1, "2", new Identity());
	...
	// 	Layer3 actualValue = layer.getNextLayer();
	...
	public void testGetWeightsMatrix() {
        ...
        NeuralNetwork3 nn = new NeuralNetwork3();
